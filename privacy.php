...
<body class="center-all flex-column">
    <h1>Politique de Confidentialité de Shizumi</h1>
    <main class="center-all flex-column privacy-main">
        <div class="box box-padding-30 small-space-around">
