...
<body>
    ...
    <main class="home-page">
        ...
        <div class="connection-box desktop-only-element">
            ...
            <form name="login-form" method="post" action="connect.php">
                <label for="log-username">Nom d'utilisateur</label>
        ...
        <div class="connection-box desktop-only-element">
            ...
            <form name="register-form" action="create.php">
                ...
                <div class="id-tooltip">
                    ...
                    <span class="id-tooltiptext">Indiquez un nom d'utilisateur unique. Celui-ci doit contenir minimum 5 caractères et maximum 20 caractères.</span>
                </div>
                <label>Mot de passe</label>
